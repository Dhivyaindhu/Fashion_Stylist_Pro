...
function buildAvatar(result: any, dressB64: string|null): string {
  ...
  const db_url=`https://api.dicebear.com/9.x/adventurer/svg?seed=${skinTone+bodyType}&skinColor=${pal.ds}&hairColor=${pal.h}&backgroundColor=transparent&scale=80&radius=50`
