            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(310px,1fr))', gap: 20 }}>
              ...
              <div>
                ...
                <div style={{ marginTop: 10, padding: '10px 14px', background: '#0d0d22', border: '1px solid #2a2060', borderRadius: 10, fontSize: 11, lineHeight: 1.8 }}>
                  <div style={{ marginBottom: 4, color: '#c0a0ff', fontWeight: 700, fontSize: 12 }}>⚡ Smart Fallback — Best Quality Always</div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ background: '#1e1048', color: '#8060c0', fontSize: 10, padding: '1px 7px', borderRadius: 4, fontWeight: 700, minWidth: 130, textAlign: 'center' }}>IDM-VTON · Free</span>
                      <span style={{ color: '#5a6898' }}>Tries first · photorealistic · free · ~5-10/day</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ background: '#1a0d00', color: '#f97316', fontSize: 10, padding: '1px 7px', borderRadius: 4, fontWeight: 700, minWidth: 130, textAlign: 'center' }}>IDM-VTON · Replicate</span>
                      <span style={{ color: '#5a6898' }}>Fallback · photorealistic · ~₹4/try-on · unlimited</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      <span style={{ background: '#0d2010', color: '#22c55e', fontSize: 10, padding: '1px 7px', borderRadius: 4, fontWeight: 700, minWidth: 130, textAlign: 'center' }}>HF Space · YOLOv8</span>
                      <span style={{ color: '#5a6898' }}>Last resort · free · unlimited · basic quality</span>
                    </div>
                  </div>
                </div>
              </div>
