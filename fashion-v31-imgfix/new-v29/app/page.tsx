          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(310px,1fr))', gap: 20 }}>
              ...
              <div>
                ...
                <div style={{ marginTop: 10, padding: '10px 12px', background: '#0d0d22', border: '1px solid #22c55e22', borderRadius: 10, fontSize: 11, color: '#5a6898', lineHeight: 1.7 }}>
                  <b style={{ color: '#22c55e' }}>✅ Free &amp; Photorealistic</b> — uses <b style={{ color: '#c0a0ff' }}>yisol/IDM-VTON</b> on HuggingFace (same model as Replicate, no payment).<br/>
                  Add a free <code style={{ color: '#8060c0' }}>HF_TOKEN</code> in <code style={{ color: '#8060c0' }}>.env.local</code> — get it at <b style={{ color: '#c0a0ff' }}>huggingface.co/settings/tokens</b>.<br/>
                  Queue wait: ~30s–2min on free tier.
                </div>
              </div>
